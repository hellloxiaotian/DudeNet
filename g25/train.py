    ...
    for epoch in range(opt.epochs):
	    ...
	    imgn_train = imgn_train.cuda() #tcw201809131432
 	    ...
 	    #img_train = img_train.cuda()
            ...
            loss = criterion(out_train, img_train) / (imgn_train.size()[0]*2) #tcw201809182256tcw
            #loss =  criterion(out_train, img_train) / (imgn_train.size()[0]*2)+(tv_norm(out_train,2.0)*1.e-5/imgn_train.size()[0]).cuda()
